...
export function DashboardPage() {
  ...
  return (
    <>
      <SEO
        title="Dashboard"
        description="Your writing dashboard - track your progress, view recent entries, and continue your mindful writing journey."
      />
        ...
        <>
          ...
          {(() => {
            ...
            const progressPercentage = Math.min(
              (data.stats.todayWords / data.stats.dailyGoal) * 100,
              100
            );
